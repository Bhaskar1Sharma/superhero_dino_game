...
!(function () {
  ...
  function m(t, i, s, e, n, o, a) {
    (this.canvasCtx = t),
      ...
      (this.size = h(1, m.MAX_OBSTACLE_LENGTH)),
      (this.dimensions = e),
      (this.remove = !1),
      (this.xPos = e.WIDTH + (a || 0)),
      (this.yPos = 0),
      (this.width = 0),
      (this.collisionBoxes = []),
      (this.gap = 0),
  ...
  function f(t, i, s) {
    (this.canvas = t),
      ...
      (this.yPos = 0),
      (this.remove = !1),
      (this.cloudGap = h(f.config.MIN_CLOUD_GAP, f.config.MAX_CLOUD_GAP)),
      this.init();
  }
  ...
  (t.config = {
    ...
    (t.prototype = {
      ...
      setupDisabledRunner: function () {
        (this.containerEl = document.createElement("div")),
          (this.containerEl.className = t.classes.SNACKBAR),
          ...
          document.addEventListener(
            t.events.KEYDOWN,
            function (i) {
              t.keycodes.JUMP[i.keyCode] &&
                (this.containerEl.classList.add(t.classes.SNACKBAR_SHOW),
      ...
      loadImages: function () {
        ...
        s
          ? ((t.imageSprite = document.getElementById(resourceId2)),
          ...
          t.imageSprite.complete
            ? this.init()
            : t.imageSprite.addEventListener(
                t.events.LOAD,
                this.init.bind(this)
              );
      },
        ...
        if (((this.time = i), this.playing)) {
          ...
          if (
            ...
            this.playingIntro
              ...
              : ((s = this.activated ? s : 0),
                this.horizon.update(s, this.currentSpeed, e, this.inverted)),
            e &&
            (function (i, s, e) {
              ...
              if (u(n, h))
                for (
                  var o = i.collisionBoxes,
                    a = s.ducking
                      ? T.collisionBoxes.DUCKING
                      : T.collisionBoxes.RUNNING,
                    r = 0;
                  r < a.length;
                  r++
                )
            ...
            n > 0 &&
              ...
              this.invertTrigger &&
                0 === this.invertTimer &&
                ((this.invertTimer += s), this.invert()));
          }
        }
        (this.playing ||
          (!this.activated &&
            this.tRex.blinkCount < t.config.MAX_BLINK_COUNT)) &&
          (this.tRex.update(s), this.scheduleNextUpdate());
      },
      ...
      onKeyDown: function (i) {
        n && this.playing && i.preventDefault(),
          i.target != this.detailsButton &&
            (this.crashed ||
              (!t.keycodes.JUMP[i.keyCode] && i.type != t.events.TOUCHSTART) ||
              (this.playing ||
                (this.loadSounds(),
                (this.playing = !0),
                this.update(),
      ...
      isLeftClickOnCanvas: function (i) {
        return (
          null != i.button &&
          i.button < 2 &&
          i.type == t.events.MOUSEUP &&
          i.target == this.canvas
        );
      },
      ...
      gameOver: function () {
        ...
        this.playSound(this.soundFx.HIT),
          (t = 200),
          n && window.navigator.vibrate && window.navigator.vibrate(t),
          this.stop(),
          (this.crashed = !0),
      ...
      play: function () {
        this.crashed ||
          ((this.playing = !0),
          (this.paused = !1),
          this.tRex.update(0, T.status.RUNNING),
          (this.time = a()),
          this.update());
      },
      restart: function () {
    ...
    (r.prototype = {
      ...
      draw: function () {
        ...
        s && ((h *= 2), (n *= 2), (o *= 2), (a *= 2), (m *= 2), (T *= 2)),
          (n += this.textImgPos.x),
          (h += this.textImgPos.y),
          this.canvasCtx.drawImage(t.imageSprite, n, h, o, a, c, d, u, l),
    ...
    (m.MAX_GAP_COEFFICIENT = 1.5),
    (m.MAX_OBSTACLE_LENGTH = 3),
    (m.prototype = {
      init: function (t) {
        if (
      ...
      draw: function () {
        ...
        s && ((i *= 2), (e *= 2));
        var n = i * this.size * (0.5 * (this.size - 1)) + this.spritePos.x;
        this.currentFrame > 0 && (n += i * this.currentFrame),
          this.canvasCtx.drawImage(
            t.imageSprite,
            n,
            this.spritePos.y,
      ...
      update: function (t, s) {
        this.remove ||
          (this.typeConfig.speedOffset && (s += this.speedOffset),
    ...
    (T.prototype = {
      ...
      update: function (t, i) {
        (this.timer += t),
          i &&
            ((this.status = i),
            (this.currentFrame = 0),
            (this.msPerFrame = T.animFrames[i].msPerFrame),
            (this.currentAnimFrames = T.animFrames[i].frames),
            i == T.status.WAITING &&
              ((this.animStartTime = a()), this.setBlinkDelay())),
          this.playingIntro &&
      ...
      draw: function (i, e) {
        var n = i,
          h = e,
          o =
            this.ducking && this.status != T.status.CRASHED
        ...
        s && ((n *= 2), (h *= 2), (o *= 2), (a *= 2)),
          ...
          this.ducking && this.status != T.status.CRASHED
            ...
            : (this.ducking && this.status == T.status.CRASHED && this.xPos++,
              this.canvasCtx.drawImage(
                t.imageSprite,
                n,
                h,
      ...
      startJump: function (t) {
        this.jumping ||
          (this.update(0, T.status.JUMPING),
      ...
      setDuck: function (t) {
        t && this.status != T.status.DUCKING
          ? (this.update(0, T.status.DUCKING), (this.ducking = !0))
          : this.status == T.status.DUCKING &&
            (this.update(0, T.status.RUNNING), (this.ducking = !1));
      },
      reset: function () {
        (this.yPos = this.groundYPos),
          (this.jumpVelocity = 0),
    ...
    (p.yPos = [0, 13, 27, 40, 53, 67, 80, 93, 107, 120]),
    (p.config = {
    ...
    (p.prototype = {
      ...
      draw: function (t, i, e) {
        ...
        this.canvasCtx.drawImage(this.image, o, a, n, h, r, c, d, u),
    ...
    (f.prototype = {
      init: function () {
        (this.yPos = h(f.config.MAX_SKY_LEVEL, f.config.MIN_SKY_LEVEL)),
          this.draw();
      },
      draw: function () {
        this.canvasCtx.save();
    ...
    (g.phases = [140, 120, 100, 60, 40, 20, 0]),
    (g.prototype = {
      update: function (t, i) {
        if (
          (t &&
            0 == this.opacity &&
            (this.currentPhase++,
            this.currentPhase >= g.phases.length && (this.currentPhase = 0)),
          t && (this.opacity < 1 || 0 == this.opacity)
            ? (this.opacity += g.config.FADE_SPEED)
            : this.opacity > 0 && (this.opacity -= g.config.FADE_SPEED),
          this.opacity > 0)
        ) {
          if (
            ((this.xPos = this.updateXPos(this.xPos, g.config.MOON_SPEED)),
            this.drawStars)
          )
            for (var s = 0; s < g.config.NUM_STARS; s++)
      ...
      draw: function () {
        ...
        if (
          (s &&
            ((i *= 2),
            (e *= 2),
            (n = this.spritePos.x + 2 * g.phases[this.currentPhase]),
            (o *= 2),
            (a = t.spriteDefinition.HDPI.STAR.x)),
          this.canvasCtx.save(),
          (this.canvasCtx.globalAlpha = this.opacity),
          this.drawStars)
        )
          for (var r = 0; r < g.config.NUM_STARS; r++)
            this.canvasCtx.drawImage(
              t.imageSprite,
              a,
              this.stars[r].sourceY,
              o,
              o,
              Math.round(this.stars[r].x),
              this.stars[r].y,
              g.config.STAR_SIZE,
              g.config.STAR_SIZE
            );
      ...
      placeStars: function () {
        for (
          var i = Math.round(this.containerWidth / g.config.NUM_STARS), e = 0;
          e < g.config.NUM_STARS;
          e++
        )
          (this.stars[e] = {}),
            (this.stars[e].x = h(i * e, i * (e + 1))),
            (this.stars[e].y = h(0, g.config.STAR_MAX_Y)),
            (this.stars[e].sourceY = s
              ? t.spriteDefinition.HDPI.STAR.y + 2 * g.config.STAR_SIZE * e
              : t.spriteDefinition.LDPI.STAR.y + g.config.STAR_SIZE * e);
      },
      reset: function () {
    ...
    (E.prototype = {
      setSourceDimensions: function () {
        for (var t in E.dimensions)
          s
            ? "YPOS" != t && (this.sourceDimensions[t] = 2 * E.dimensions[t])
            : (this.sourceDimensions[t] = E.dimensions[t]),
    ...
    (I.prototype = {
      ...
      addNewObstacle: function (i) {
        var s = h(0, m.types.length - 1),
          e = m.types[s];
        if (this.duplicateObstacleCheck(e.type) || i < e.minSpeed)
          ...
          this.obstacles.push(
            ...
            this.obstacleHistory.length > 1 &&
              this.obstacleHistory.splice(t.config.MAX_OBSTACLE_DUPLICATION);
        }
      },
      duplicateObstacleCheck: function (i) {
        for (var s = 0, e = 0; e < this.obstacleHistory.length; e++)
          s = this.obstacleHistory[e] == i ? s + 1 : 0;
      ...
      addCloud: function () {
        this.clouds.push(
          new f(this.canvas, this.spritePos.CLOUD, this.dimensions.WIDTH)
        );
      },
    });
})(),
...
function c() {
  //console.log(1);
  // istrue = !istrue;
  let x = document.getElementById("offline-resources-2x");
  x.src = "assets/default_200_percent/mario2x.png?" + new Date().getTime();
  let y = document.getElementById("offline-resources-1x");
  y.src = "assets/default_100_percent/mario1x.png?" + new Date().getTime();
  let imageUrl = "assets/wallpapers/mario_wallpaper.png";
  $(".batman").css("background-image", "url(" + imageUrl + ")");
  // window.location.reload();
}
function d() {
  // window.location.reload();
  //console.log(22);
  let x = document.getElementById("offline-resources-2x");
  x.src = "assets/default_200_percent/batman2x.png?" + new Date().getTime();
  let y = document.getElementById("offline-resources-1x");
  y.src = "assets/default_100_percent/batman1x.png?" + new Date().getTime();
  let imageUrl = "assets/wallpapers/batman_wallpaper.jpg";
  $(".batman").css("background-image", "url(" + imageUrl + ")");
}
function e() {
  // window.location.reload();
  //console.log(22);
  let x = document.getElementById("offline-resources-2x");
  x.src = "assets/default_200_percent/naruto2x.png?" + new Date().getTime();
  let y = document.getElementById("offline-resources-1x");
  //y.src = "assets/default_100_percent/download.png?" + new Date().getTime();
  y.src = "assets/default_100_percent/naruto1x.png?" + new Date().getTime();
  let imageUrl = "assets/wallpapers/naruto_wallpaper.jpg";
  $(".batman").css("background-image", "url(" + imageUrl + ")");
}
